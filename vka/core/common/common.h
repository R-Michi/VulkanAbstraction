...
{
    /**
     * @brief Implements a one-time submission command buffer.
    ...
    {
    private:
        static constexpr char CBO_ALLOC_FAILED[] = "[vka::CommandBufferOTS::begin]: Failed to allocate command buffer.";
        static constexpr char CBO_BEGIN_FAILED[] = "[vka::CommandBufferOTS::begin]: Failed to begin command buffer recording.";
        static constexpr char CBO_END_FAILED[] = "[vka::CommandBufferOTS::end/end_wait]: Failed to end command buffer recording.";
        static constexpr char CBO_SUBMIT_FAILED[] = "[vka::CommandBufferOTS::end/end_wait]: Failed to submit command buffer.";
        static constexpr char WAIT_QUEUE_FAILED[] = "[vka::CommandBufferOTS::end_wait]: Failed to wait for queue to become idling.";
        static constexpr char WAIT_FENCE_FAILED[] = "[vka::CommandBufferOTS::end/end_wait]: Failed to wait for fence.";
    ...
    public:
        ...
        inline CommandBufferOTS() noexcept;
        ...
        /**
         * @brief Moves the ownership of a command buffer to a different object.
         * @param src Specifies the command buffer to move.
         * @details The source command buffer becomes invalidated. If the move destination has been created before and
        ...
        /**
         * @brief Ends the recording of the command buffer and executes the commands.
        ...
        /**
         * @brief Ends the recording of the command buffer, executes the commands and waits until the commands have been
         * executed.
         * @param queue Specifies a valid queue to submit the commands to.
